"""
    Preconfigured builder for tcc projects.
"""
...
# Define a process for building TCC projects
class TCCBuilder:

    # Define a process for building a TCC project
    def __init__(self,
        root_dir     : Path,
        logger       : Logger,
        rom_name     : str,
        ...
        """
        Create a builder to compile, assemble and link tcc projects
